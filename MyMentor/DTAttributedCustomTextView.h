...
@class DTAttributedCustomTextView;
...
@interface DTAttributedCustomTextView : UIScrollView
{
    DTAttributedTextContentView *_attributedTextContentView;
}

	// ivars needed by subclasses
@property (strong, nonatomic,readonly ) DTAttributedTextContentView *attributedTextContentView;
...
@property (nonatomic, strong) NSDate *lastScrollDate;
...
@property (assign, nonatomic) BOOL userDidScroll;
...
/**
 ...
 @param animated `YES` if the movement should be animated.
 */
- (void)scrollRangeToVisible:(NSRange)range reset:(BOOL)animated;
